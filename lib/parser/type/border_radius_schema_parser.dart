...
@SchemaParser("BorderRadius", 
    "https://legytma.com.br/schema/border_radius.schema.json", <String>[
  "only",
  "all",
  "circular",
  "zero",
...
class BorderRadiusSchemaParser extends VariantTypeSchemaParser<BorderRadius,
    Map<String, dynamic>, BorderRadiusGeometry> {
  ...
  /*
  @override
  VariantTypeSchemaParser<BorderRadius, Map<String, dynamic>,
      BorderRadiusGeometry> newVariantInstance(String schemaUri) {
    return BorderRadiusSchemaParser(schemaUri, null);
  }
  */

  @override
   BorderRadius builderVariant(BuildContext buildContext,
      Map<String, dynamic> value, BorderRadiusGeometry defaultValue) {
    switch (value['type']) {
      case 'all':
      ...
      case 'only':
        return BorderRadius.only(
          ...
          topRight: SchemaWidget.parse<Radius>(buildContext, value['topRight']),
          bottomLeft:
