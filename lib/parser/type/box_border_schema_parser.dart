...
/// Schema parser from [Map<String, dynamic>] to [BoxBorder]
///
/// Created by Windol <windol@legytma.com.br> at 28/04/2020.
/// Copyright (c) 2020 Legytma Soluções Inteligentes (https://legytma.com.br). All rights reserved.
@SchemaParser("BoxBorder", "https://schema.legytma.com.br/1.1.2/schema/box_border.schema.json")
class BoxBorderSchemaParser
  ...
  @override
   BoxBorder builder(BuildContext buildContext, Map<String, dynamic> value,
    ...
    return SchemaWidget.parse<Border>(buildContext, value, defaultValue);
  }
}
