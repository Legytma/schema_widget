...
/// Schema parser from [List] to [ListBoxShadow]
///
/// Created by Windol <windol@legytma.com.br> at 29/04/2020.
/// Copyright (c) 2020 Legytma Soluções Inteligentes (https://legytma.com.br). All rights reserved.
@SchemaParser("List<BoxShadow>", "https://schema.legytma.com.br/1.1.2/schema/list_box_shadow.schema.json")
  ...
  @override
   List<BoxShadow> builder(BuildContext buildContext, List value,
    ...
    for (var item in value) {
      var parsedItem = SchemaWidget.parse<BoxShadow>(buildContext, item);
