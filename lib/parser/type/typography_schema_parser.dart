...
/// Schema parser from [Map<String, dynamic>] to [Typography]
///
/// Created by Windol <windol@legytma.com.br> at 27/04/2020.
/// Copyright (c) 2020 Legytma Soluções Inteligentes (https://legytma.com.br). All rights reserved.
@SchemaParser("Typography", "https://legytma.com.br/schema/typography.schema.json")
  ...
  @override
   Typography builder(BuildContext buildContext, Map<String, dynamic> map,
    ...
    return Typography(
      ...
      dense: SchemaWidget.parse<TextTheme>(buildContext, map['dense']),
      englishLike:
          SchemaWidget.parse<TextTheme>(buildContext, map['englishLike']),
      tall: SchemaWidget.parse<TextTheme>(buildContext, map['tall']),
      white: SchemaWidget.parse<TextTheme>(buildContext, map['white']),
    );
  }
}
